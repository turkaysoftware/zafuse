...
namespace Zafuse{
    internal class TSModules{
        ...
        public class TS_LinkSystem{
            public const string
            // Main Control Links
            github_link_lv      = "https://raw.githubusercontent.com/turkaysoftware/zafuse/main/Zafuse/SoftwareVersion.txt",
            github_link_lr      = "https://github.com/turkaysoftware/zafuse/releases/latest",
            // Social Links
        ...
        // READ LANG PATHS
        // ======================================================================================================
        public static readonly string ts_lf = Path.Combine(StartupPath, "z_langs");     // Main Path
